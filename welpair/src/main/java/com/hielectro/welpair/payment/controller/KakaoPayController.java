...
public class KakaoPayController {
    ...
    private String tid;
    private Map<String, OrderDTO> tidOrder;
    ...
    public @ResponseBody KKPReadyResponse payReady(@ModelAttribute("order") OrderDTO order, Model model
    ) {
        log.info("주문정보:" + order);
        ...
        tidOrder = new HashMap<>();
        tidOrder.put(tid, order);
        ...
        model.addAttribute("order",readyResponse.getOrder());
    ...
    public String payCompleted(@RequestParam("pg_token") String pgToken,
        ...
        rttr.addFlashAttribute("order", tidOrder.get(tid));
